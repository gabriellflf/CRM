...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Verifique a URL ou peça para a pessoa que te convidou enviar um novo.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo — levam apenas alguns segundos para gerar.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não foi possível verificar este convite agora. Tente atualizar a página em um momento.',
  },
};
