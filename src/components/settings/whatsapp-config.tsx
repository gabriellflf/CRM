...
export function WhatsAppConfig() {
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        ...
        toast.error(
          'Número não está totalmente registrado. Veja as verificações abaixo para identificar qual etapa falhou.',
          { duration: 8000 },
        );
      }
      if (accountId) await fetchConfig(accountId);
  ...
  async function handleReset() {
    if (!confirm('Isso excluirá a configuração atual do WhatsApp para que você possa inserir novamente. Continuar?')) {
      return;
    }
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte sua API do WhatsApp Business da Meta. Credenciais, webhook e etapas de configuração ficam aqui."
        />
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu token de acesso autentica com a Meta. Veja o status de Registro abaixo para verificar se os webhooks estão configurados.'
              : statusMessage ||
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  existir, ou o registro foi ignorado. Insira o
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {config && !tokenEdited && (
                <p className="text-xs text-muted-foreground">
                  Token ocultado por segurança. Insira novamente para atualizar a configuração.
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para configurar mensagens <strong className="text-muted-foreground">recebidas</strong> para um número de{' '}
                <strong className="text-muted-foreground">produção</strong>. Defina-o em{' '}
                <strong className="text-muted-foreground">
                  Meta Business Manager → Contas WhatsApp → Números de
                  Telefone → Verificação em duas etapas
                </strong>
                , depois cole aqui para que o wacrm possa inscrever o número —
                caso contrário, a Meta encaminha eventos recebidos para o app
                ...
                Deixar em branco também mantém um registro existente intacto.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <Accordion>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    <li>Acesse WhatsApp &gt; Configuração de API</li>
                    ...
                    <li>Gere um <strong className="text-foreground">Token de Acesso Permanente</strong> em Configurações do Business &gt; Usuários do Sistema</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
