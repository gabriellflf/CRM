        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              A URL de convite em texto simples é exibida apenas uma vez na criação
              por segurança — para compartilhar novamente, revogue o convite abaixo e
              crie um novo.
            </p>
          ) : null}
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              da conta? Eles serão desconectados desta conta
              e receberão uma nova conta pessoal no próximo acesso. O
