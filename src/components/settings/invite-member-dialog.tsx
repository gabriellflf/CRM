...
export function InviteMemberDialog({
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const message = `Entre em ${accountName} no wacrm usando este link (válido por ${result?.expiresInDays} dia${result?.expiresInDays === 1 ? '' : 's'}): ${url}`;
        ...
        {result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                criar uma conta (ou entrar) e ingressar na conta como{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto simples — uma vez que você fechar este
                diálogo, a URL desaparece. Para compartilhar novamente, revogue
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Gere um link de convite único. Compartilhe pelo WhatsApp,
